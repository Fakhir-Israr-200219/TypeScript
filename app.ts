...
// ============================  Type inference vedio number           7
// let data = 20;                  //type === number     aoutomaticaly
// let hhh = "string"              //type === number     aoutomaticaly
...
// when the data type is equal to any like that
// let data;
// data = "stfsf";
// data = 34;
// data = true
